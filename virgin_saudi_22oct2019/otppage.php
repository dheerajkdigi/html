...
<div class="bottombg otp">
	<div class="txtbtm">
		...
		<p class="entmob1" style="bottom:380px;">Welcome : +966<?php echo $_REQUEST['msisdn']; ?></p>
	  ...
	  Terms and Conditions:<br/>
		...
		<li>No commitment, you can cancel your subscription at anytime by sending Unsub U1 to 300304</li>
