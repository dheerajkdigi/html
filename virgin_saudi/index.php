...
if($msg == "invalid_msisdn"){
	$message = "Incorrect Number ! Please Enter Valid Virgin Mobile Number";
}
else{
	$message = "Enter Your Virgin Mobile Number";
}
?>
<!doctype html>
<html>
...
<div class="bottombg page">
	<div class="txtbtm">
		...
		<p class="txtblock"><input type="text" class="otptxta" placeholder="+966" disabled><input type="text" name="msisdn" class="otptxt" placeholder="**********"></p>
