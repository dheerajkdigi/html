	...
	*/
	function getUserProfile()
	{
		...
		$response = $this->api->api( "https://www.googleapis.com/oauth2/v2/userinfo" ); 
                //debug($response);
                $gplus_response = $this->api->api( "https://www.googleapis.com/plus/v1/people/me" ); 
                //debug($gplus_response);
		...
		if( property_exists($gplus_response,'birthday') ){ 
			list($birthday_year, $birthday_month, $birthday_day) = explode( '-', $gplus_response->birthday );
