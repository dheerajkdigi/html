        ...
        <div class="box">
            <div class="box-body">
                ...
                <fieldset id="Item">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2 text-left" for="COURIER_NAME">Courier Name<span class="required">*</span>:</label>
                        <div class="col-sm-10">
                            <input class="form-control COURIER_NAME" type="text" name="COURIER_NAME" value="<?php echo (isset($purchase->COURIER_NAME)) ? $purchase->COURIER_NAME:'';?>" required maxlength="100"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 text-left" for="DOCKET_NO">Docket No.<span class="required">*</span>:</label>
                        <div class="col-sm-10">
                            <input class="form-control DOCKET_NO" type="text" name="DOCKET_NO" value="<?php echo (isset($purchase->DOCKET_NO)) ? $purchase->DOCKET_NO:'';?>" required maxlength="100"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 text-left" for="DOCKET_DATE">Docket Date<span class="required">*</span>:</label>
                        <div class="col-sm-10">
                            <input id="DOCKET_DATE" class="form-control datepicker" type="text" name="DOCKET_DATE" value="<?php echo (isset($purchase->DOCKET_DATE)) ? $purchase->DOCKET_DATE:'';?>" required maxlength="20"/>
                        </div>
                    </div>
                </fieldset>
            </div>
