...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <?php } ?>
    	<div>
            <a href="<?php echo base_url('inventory/add'); ?>" class="btn btn-primary btn-lg">Add Inventory</a>
                    ...
                    <table class="table table-bordered table-striped dataTable" id="example1" aria-describedby="example1_info">
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                            ...
                            <tr>
                                ...
                                <td class="name"><a href='<?php echo base_url("inventory/listing/$category->ID");?>'><?php echo $category->NAME; ?></a></td>
                                <td class=" ">
