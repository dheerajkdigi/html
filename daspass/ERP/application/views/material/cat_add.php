...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label col-sm-2 text-left" for="UNIT">Unit<span class="required">*</span>:</label>
                    <div class="col-sm-10">
                        <input id="UNIT" class="form-control" type="text" name="UNIT" value="<?php echo (isset($category->UNIT)) ? $category->UNIT:'';?>" required maxlength="50"/>
                    </div>
                </div>
