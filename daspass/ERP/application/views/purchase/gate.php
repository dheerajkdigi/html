            ...
            <div class="box-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="BILL_NUMBER" class="form-control" type="text" name="BILL_NUMBER" required maxlength="20" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 text-left" for="BILL_DATE">Bill Date<span class="required">*</span>:</label>
                        <div class="col-sm-10">
                            <input id="BILL_DATE" class="form-control datepicker" type="text" name="BILL_DATE" required />
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="CHALLAN_NUMBER" class="form-control" type="text" name="CHALLAN_NUMBER" maxlength="20" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 text-left" for="CHALLAN_DATE">Challan Date:</label>
                        <div class="col-sm-10">
                            <input id="CHALLAN_DATE" class="form-control datepicker" type="text" name="CHALLAN_DATE" />
                        </div>
                    </div>
                </fieldset>
                <div id="itemDetails">
