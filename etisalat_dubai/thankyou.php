...
switch($msg){
  case 'already_sub':
      if($_SESSION['lang']=="arabic"){
        $message = " أنت مشترك بالفعل في تطبيق شيلبا شيتي للياقة البدنية  <br/> . يرجى تسجيل الدخول في التطبيق لتعزيز القدرة على التحمل والبقاء بصحة جيدة. ";
      }
      else {
        $message  = "You are already subscribed to <br/><strong>Shilpa Shetty Fitness APP</strong><br/>Please login in app to boost your stamina.";
      }
      
      break;
  case 'success':
      if($_SESSION['lang'] == "arabic") {
        $message = " لقد اشتركت بنجاح في تطبيق شيلبا شيتي للياقة البدنية  <br/>
                    لقد أرسلنا إليك رسالة تأكيد SMS تتضمن تفاصيل اشتراكك. <br/>
                      يرجى الحفاظ على الرسالة لتكون مرجعا في المستقبل. ";
      }
      else {
  ...
  default:
      if($_SESSION['lang']=="arabic"){
        $message = " عفوًا ... تعذر معالجة طلبك. الرجاء معاودة المحاولة في وقت لاحق  ";
      }
      else {
        $message = "Oops..Your request could not be processed. please try again later.";  
      }
